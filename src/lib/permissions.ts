...
export type ModuleKey = "dashboard" | "daily" | "kpi" | "documents" | "expenses" | "agency" | "reconcile" | "reports" | "forms" | "surveys" | "contacts" | "settings" | "users";
...
export const MENU_ACCESS: Record<Role, ModuleKey[]> = {
  admin:       ["dashboard", "daily", "kpi", "documents", "expenses", "agency", "reconcile", "reports", "forms", "surveys", "contacts", "settings", "users"],

...
export type ModuleKey = "dashboard" | "daily" | "kpi" | "documents" | "expenses" | "agency" | "reports" | "forms" | "contacts" | "settings";
...
export const MENU_ACCESS: Record<Role, ModuleKey[]> = {
  admin:       ["dashboard", "daily", "kpi", "documents", "expenses", "agency", "reports", "forms", "contacts", "settings"],

...
const DOC_KEYWORDS: Record<string, string[]> = {
  ...
  교육생일지: ["교육생일지", "교육생 일지", "학습일지", "학습 일지", "교육일지", "교육 일지", "수강생일지", "수강생 일지"],
  코디일지: ["코디일지", "코디 일지", "코디네이터일지", "운영일지", "운영 일지", "코디 보고서", "코디보고서", "코디네이터 보고서", "일일보고서", "수업 보고서", "수업보고서"],
  강사비지급확인서: ["강사비지급확인서", "강사비 지급확인", "강사비", "강사 수당", "지급확인서"],
  경비영수증: ["경비영수증", "경비 영수증", "영수증", "경비 정산", "경비", "지출결의서", "출장비 품의서", "출장비품의서", "출장비"],
};
